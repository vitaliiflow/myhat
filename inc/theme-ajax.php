    ...
    <div class="search__resultsList__content">
        <?php if($the_query->have_posts()): ?> 
            ...
            <div class="pt_name"><?php echo $pt_name->label; ?></div>
                <div class="pt_name"><?php echo 'Products'; ?></div>
...
function products_filter() {
    ...
    if($the_query->have_posts()): ?>
        ...
        <?php 
            if(!empty($kategori)){
                $link = get_term_link($kategori[0], 'product_cat');
            } elseif(!empty($team)){
                $link = get_term_link($team[0], 'team');
            } elseif(!empty($varumarke)){
                $link = get_term_link($varumarke[0], 'varumarke');
            }
            $prev = $paged - 1;
            $next = $paged + 1;
        ?>
